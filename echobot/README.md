# echobot
Demonstrar as capacidades básicas do Microsoft Bo Framework
...
msbot clone services --name "echobot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
